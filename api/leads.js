...
module.exports = async function handler(req, res) {
  ...
  if (body.termsConsent !== 'yes') return res.status(400).json({error:'Please agree to the Terms of Use and acknowledge the Privacy Policy.'});
  ...
  data.set('text',`Property: 13300 SW 99th Terrace, Miami, FL 33186\n\nName: ${firstName} ${lastName}\nEmail: ${email}\nPhone: ${phone}\n\nMessage:\n${message || 'No additional message.'}\n\nTerms accepted / privacy acknowledged: Yes\nMarketing calls/texts consent: ${body.marketingConsent === 'yes' ? 'Yes' : 'No'}\nConsent version: 2026-09-17\nSource: https://${origin}/#contact\n\nSubmitted: ${new Date().toISOString()}`);
